...
-- Seeds
INSERT INTO clients (name, contact_name, email, phone, invoice_prefix, hourly_rate)
VALUES ('Unik Orthopedics', 'Charlie Chi', 'charlie@bwurxs.com', '408-887-5842', 'UNIK', 50.00) -- default_rate
ON DUPLICATE KEY UPDATE name = name;

INSERT INTO client_ticket_sequences (client_id, last_number)
SELECT id, 0 FROM clients WHERE invoice_prefix = 'UNIK'
